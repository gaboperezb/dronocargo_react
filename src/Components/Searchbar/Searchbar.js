...
class SearchBar extends React.Component {
    ...
    render() {
      ...
      return (
        <form className="delivery-actions__element form">
          <div className="form__group">
            <div className="form__item">
              ...
              <input value={filterId} onChange={this.handleFilterIdChange} className="form__input form__input--wli" type="text" placeholder="Search" id="search" />
            </div>
          </div>
        </form>
      );
