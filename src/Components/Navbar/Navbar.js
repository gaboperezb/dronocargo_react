...
class Navbar extends React.Component {
    render() {
      return (
        <nav className="nav">
          <a className="nav__element nav__element--bold" href="#">Dronocargo</a>
          <a className="nav__element user" href="#">
            <span className="user__name">Regina Zepeda</span>
            <svg className="user__icon" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
